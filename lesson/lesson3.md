...
## Домашнее задание
- Закончить реализацию `AbstractArrayStorage`, `ArrayStorageVersion`, `SortedArrayStorage` (`SortedArrayStorage` хранит элементы отсортированными, сортировать весь массив не надо).
- Сделать проверку `ArrayStorageVersion.update`
